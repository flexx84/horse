...
function check_all(f)
{
    ...
    for (i=0; i<chk.length; "");="" "#828282");="" "#8c8c8c");="" "#eff3f9");="" "#ff0000");="" "#ff6600");="" "#ffffcc");="" "#ffffff");="" ".php";="" "1")="" "1px="" "analysis_01")="" "analysis_02")="" "analysis_03")="" "data3_all")="" "data3_chatlive"="" "delete")="" "error")="" "json",="" "ok")="" "post",="" "sdata_all")="" "sdata_basic"="" "sdata_basic")="" "sdata_clear")="" "sdata_prize_all")="" "sdata_prize_basic"="" "sdata_prize_basic")="" "sdata_prize_clear")="" "update")="" "할="" #d6dce7");="" #ff0000");="" #rc_analysis").load("..="" $("#rc_analysis").height(rc_analysis_height="" $("#rc_analysis").html(response);="" $("#rc_analysis").load("..="" $("#sdata_5ty").prop("checked",="" $("#sdata_ability").prop("checked",="" $("#sdata_airesult").prop("checked",="" $("#sdata_distance").prop("checked",="" $("#sdata_eraser").prop("checked",="" $("#sdata_eraser2").prop("checked",="" $("#sdata_expert").prop("checked",="" $("#sdata_fieldodds").prop("checked",="" $("#sdata_hrage").prop("checked",="" $("#sdata_hrsex").prop("checked",="" $("#sdata_jkname").prop("checked",="" $("#sdata_mypercent").prop("checked",="" $("#sdata_plcodds").prop("checked",="" $("#sdata_popular").prop("checked",="" $("#sdata_prize").prop("checked",="" $("#sdata_prize_1m").prop("checked",="" $("#sdata_prize_2m").prop("checked",="" $("#sdata_prize_3r").prop("checked",="" $("#sdata_prize_4r7r").prop("checked",="" $("#sdata_prize_5ty").prop("checked",="" $("#sdata_prize_7r").prop("checked",="" $("#sdata_prize_airesult").prop("checked",="" $("#sdata_prize_bigdata").prop("checked",="" $("#sdata_prize_expert").prop("checked",="" $("#sdata_prize_jkname").prop("checked",="" $("#sdata_prize_odds").prop("checked",="" $("#sdata_prize_rank").prop("checked",="" $("#sdata_prize_rank_sum").prop("checked",="" $("#sdata_prize_ranking").prop("checked",="" $("#sdata_prize_ranking_sum").prop("checked",="" $("#sdata_prize_ranking_sum2").prop("checked",="" $("#sdata_prize_rmemo").prop("checked",="" $("#sdata_prize_s1f").prop("checked",="" $("#sdata_prize_sangma").prop("checked",="" $("#sdata_prize_total").prop("checked",="" $("#sdata_rank").prop("checked",="" $("#sdata_ranking").prop("checked",="" $("#sdata_rating").prop("checked",="" $("#sdata_rcdate").prop("checked",="" $("#sdata_rmemo").prop("checked",="" $("#sdata_s1f").prop("checked",="" $("#sdata_trname").prop("checked",="" $("#sdata_wgbudam").prop("checked",="" $("#sdata_winodds").prop("checked",="" $(".hrmemo").keyup(function(key)="" $(".hrname_memo").css("height","");="" $(".hrname_memo").css("height","200px");="" $(".hrname_memo").mouseout(function()="" $(".hrname_memo").mouseover(function()="" $(".hrno_form").keyup(function(key)="" $(".hrpossible").keyup(function(key)="" $(".mover_red_button").mouseout(function()="" $(".mover_red_button").mouseover(function()="" $(".search_checkbox").attr("disabled",="" $(".trline"="" $(".trline").on("mouseout",="" $(".trline").on("mouseover",="" $(".trlineshow"="" $(e).attr("disabled",="" $(this).children("input").css("background-color",="" $(this).css("background",="" $(this).css("background-color",="" $(this).css("border-top",="" $(this).css("color",="" $(this).parent().css("background",="" $.ajax({="" %="" 'analysis':analysis,="" 'dtype':dtype,="" 'html',="" 'match_item':match_item,="" 'meet':meet,="" 'post',="" 'px');="" 'rcdate':rcdate,="" 'rcno':rcno,="" 'rcno':rcno},="" 'sdata_5ty':sdata_5ty,="" 'sdata_ability':sdata_ability,="" 'sdata_airesult':sdata_airesult,="" 'sdata_distance':sdata_distance,="" 'sdata_eraser':sdata_eraser,="" 'sdata_eraser2':sdata_eraser2,="" 'sdata_expert':sdata_expert,="" 'sdata_fieldodds':sdata_fieldodds,="" 'sdata_hrage':sdata_hrage,="" 'sdata_hrsex':sdata_hrsex,="" 'sdata_jkname':sdata_jkname,="" 'sdata_mypercent':sdata_mypercent,="" 'sdata_plcodds':sdata_plcodds,="" 'sdata_popular':sdata_popular,="" 'sdata_prize':sdata_prize,="" 'sdata_prize_1m':sdata_prize_1m,="" 'sdata_prize_2m':sdata_prize_2m,="" 'sdata_prize_3r':sdata_prize_3r,="" 'sdata_prize_4r7r':sdata_prize_4r7r,="" 'sdata_prize_5ty':sdata_prize_5ty,="" 'sdata_prize_7r':sdata_prize_7r,="" 'sdata_prize_airesult':sdata_prize_airesult,="" 'sdata_prize_bigdata':sdata_prize_bigdata,="" 'sdata_prize_expert':sdata_prize_expert,="" 'sdata_prize_jkname':sdata_prize_jkname,="" 'sdata_prize_odds':sdata_prize_odds,="" 'sdata_prize_rank':sdata_prize_rank,="" 'sdata_prize_rank_sum':sdata_prize_rank_sum,="" 'sdata_prize_ranking':sdata_prize_ranking,="" 'sdata_prize_ranking_sum':sdata_prize_ranking_sum,="" 'sdata_prize_ranking_sum2':sdata_prize_ranking_sum2,="" 'sdata_prize_rmemo':sdata_prize_rmemo,="" 'sdata_prize_s1f':sdata_prize_s1f,="" 'sdata_prize_sangma':sdata_prize_sangma,="" 'sdata_prize_total':sdata_prize_total,="" 'sdata_rank':sdata_rank,="" 'sdata_ranking':sdata_ranking,="" 'sdata_rating':sdata_rating,="" 'sdata_rcdate':sdata_rcdate,="" 'sdata_resultview':sdata_resultview},="" 'sdata_rmemo':sdata_rmemo,="" 'sdata_s1f':sdata_s1f,="" 'sdata_site1':sdata_site1,="" 'sdata_site2':sdata_site2,="" 'sdata_trname':sdata_trname,="" 'sdata_value':sdata_value,="" 'sdata_wgbudam':sdata_wgbudam,="" 'sdata_winodds':sdata_winodds,="" 'sod':sod,="" 'sst':sst,="" 'viewtype':sdata_viewtype,="" (!bchk)="" (!confirm("선택한="" ($("#sdata_5ty").is(":checked"))="" ($("#sdata_ability").is(":checked"))="" ($("#sdata_airesult").is(":checked"))="" ($("#sdata_distance").is(":checked"))="" ($("#sdata_eraser").is(":checked"))="" ($("#sdata_eraser2").is(":checked"))="" ($("#sdata_expert").is(":checked"))="" ($("#sdata_fieldodds").is(":checked"))="" ($("#sdata_hrage").is(":checked"))="" ($("#sdata_hrsex").is(":checked"))="" ($("#sdata_jkname").is(":checked"))="" ($("#sdata_mypercent").is(":checked"))="" ($("#sdata_plcodds").is(":checked"))="" ($("#sdata_popular").is(":checked"))="" ($("#sdata_prize").is(":checked"))="" ($("#sdata_prize_1m").is(":checked"))="" ($("#sdata_prize_2m").is(":checked"))="" ($("#sdata_prize_3r").is(":checked"))="" ($("#sdata_prize_4r7r").is(":checked"))="" ($("#sdata_prize_5ty").is(":checked"))="" ($("#sdata_prize_7r").is(":checked"))="" ($("#sdata_prize_airesult").is(":checked"))="" ($("#sdata_prize_bigdata").is(":checked"))="" ($("#sdata_prize_expert").is(":checked"))="" ($("#sdata_prize_jkname").is(":checked"))="" ($("#sdata_prize_odds").is(":checked"))="" ($("#sdata_prize_rank").is(":checked"))="" ($("#sdata_prize_rank_sum").is(":checked"))="" ($("#sdata_prize_ranking").is(":checked"))="" ($("#sdata_prize_ranking_sum").is(":checked"))="" ($("#sdata_prize_ranking_sum2").is(":checked"))="" ($("#sdata_prize_rmemo").is(":checked"))="" ($("#sdata_prize_s1f").is(":checked"))="" ($("#sdata_prize_sangma").is(":checked"))="" ($("#sdata_prize_total").is(":checked"))="" ($("#sdata_rank").is(":checked"))="" ($("#sdata_ranking").is(":checked"))="" ($("#sdata_rating").is(":checked"))="" ($("#sdata_rcdate").is(":checked"))="" ($("#sdata_resultview").is(":checked"))="" ($("#sdata_rmemo").is(":checked"))="" ($("#sdata_s1f").is(":checked"))="" ($("#sdata_site1").is(":checked"))="" ($("#sdata_site2").is(":checked"))="" ($("#sdata_trname").is(":checked"))="" ($("#sdata_wgbudam").is(":checked"))="" ($("#sdata_winodds").is(":checked"))="" ($(e).is(":checked"))="" (act="=" (all_id="=" (analysis="=" (analysis_expert="=" (chk[i].checked)="" (dtype="=" (hr_del="=" (i="0;" (key.keycode="=" (response="=" (score="" (sdata="=" (trbg="=" (var="" +="" .container").height()="" 1)="" 13)="" 20;="" 2;="" ;="" act)="" ajax.get_race_analysis_loading.php?h='400");' ajax.token.php",="" alert("토큰="" alert(data.error);="" alert(response);="" alert(str="" all_id="=" analysis="" analysis_expert='$(e).data("analysis_expert");' async:="" bchk="true;" bg_color='$(this).data("bg_color");' bg_color);="" btn_check(f,="" cache:="" checked="true;" checked;="" checked_choice="false;" checked_choice);="" chk="document.getElementsByName(elements_name);" chk[i].checked="f.chkall.checked;" console.log(response);="" data:="" datatype:="" defaultvalue='$(this).data("defaultvalue");' delete_confirm(el)="" delete_confirm2(msg)="" document.location.href="data.url;" dtype="" dtype,="" el.href='href+"&amp;token="+token;' else="" f.action="list_delete_php;" f.submit();="" false);="" false,="" false;="" for="" function="" function()="" function(data)="" function(response)="" g5_admin_url+"="" get_ajax_token()="" get_race_analysis(dtype,="" get_race_analysis_data(e,="" get_race_analysis_data9(analysis,="" get_race_analysis_data_all(e,="" get_race_analysis_data_prize_all(e,="" get_race_analysis_point_chulno(rcdate,="" get_race_analysis_score_chulno(rcdate,="" hr_del='$(this).parent().data("hrdel");' href="el.href.replace(/&amp;token=.+$/g," hrno='$(this).parent().parent().data("hrno");' hrno).addclass("bg_yellow");="" hrno).css("background-color",="" hrno).removeclass("bg_yellow");="" i="0;" i++)="" i<chk.length;="" if="" if(!token)="" if(confirm("한번="" if(confirm(msg))="" if(data.error)="" if(data.url)="" in_hr_select($(this));="" is_checked(elements_name)="" let="" match_item="data9_match_item;" meet='$(e).parent().parent().data("meet");' meet,="" onmouseevent_control()="" onmouseevent_control();="" rc_analysis_height='$("#rc_analysis' rcdate='$(e).parent().parent().data("rcdate");' rcdate,="" rcno='$(e).parent().parent().data("rcno");' rcno);="" rcno,="" reg_data_hrmemo($(this));="" reg_hrmemo($(this));="" return="" return;="" score="Number($(this).val());" sdata='$(e).attr("id");' sdata_5ty="1" sdata_ability="" sdata_airesult="1" sdata_distance="" sdata_eraser="" sdata_eraser2="" sdata_expert="1" sdata_fieldodds="" sdata_hrage="" sdata_hrsex="" sdata_jkname="1" sdata_mypercent="" sdata_plcodds="" sdata_popular="" sdata_prize="" sdata_prize_1m="1" sdata_prize_2m="1" sdata_prize_3r="1" sdata_prize_4r7r="1" sdata_prize_5ty="1" sdata_prize_7r="1" sdata_prize_airesult="1" sdata_prize_bigdata="1" sdata_prize_expert="1" sdata_prize_jkname="1" sdata_prize_odds="1" sdata_prize_rank="1" sdata_prize_rank_sum="1" sdata_prize_ranking="1" sdata_prize_ranking_sum="1" sdata_prize_ranking_sum2="1" sdata_prize_rmemo="1" sdata_prize_s1f="1" sdata_prize_sangma="1" sdata_prize_total="1" sdata_rank="" sdata_ranking="1" sdata_rating="" sdata_rcdate="" sdata_resultview="" sdata_rmemo="1" sdata_s1f="1" sdata_site1="" sdata_site2="" sdata_trname="" sdata_value="0" sdata_viewtype="team" sdata_wgbudam="" sdata_winodds="" seq='$(this).data("seq");' seq).addclass("bg_gray");="" seq).addclass("bg_white");="" seq).css("background-color",="" seq).removeclass("bg_gray");="" seq).removeclass("bg_white");="" sleep(1000);="" sod)="" sod);="" solid="" sst,="" str="삭제" success:="" token="data.token;" token;="" trbg="parseInt(seq)" true);="" true;="" type:="" url="../analysis/ajax.get_race_analysis_" url,="" url:="" var="" {="" {'sdata':sdata,="" ||="" }="" });="" 기수="" 대전수="" 방법이="" 복구할="" 삭제="" 삭제하시겠습니까?"))="" 삭제한="" 선택삭제="" 선택수정="" 선택하세요.");="" 선행력="" 않습니다.");="" 없습니다.\n\n정말="" 올바르지="" 이상="" 자료는="" 자료를="" 전체="" 정말="" 정보가="" 하나="" 하시겠습니까?"))=""> 100) {
